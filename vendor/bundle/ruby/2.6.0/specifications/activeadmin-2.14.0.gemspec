...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<formtastic>.freeze, [">= 3.1".freeze, "< 5.0".freeze])
  ...
  s.add_runtime_dependency(%q<kaminari>.freeze, ["~> 1.0".freeze, ">= 1.2.1".freeze])
  s.add_runtime_dependency(%q<railties>.freeze, [">= 6.1".freeze, "< 7.1".freeze])
  s.add_runtime_dependency(%q<ransack>.freeze, [">= 2.1.1".freeze, "< 4".freeze])
end
