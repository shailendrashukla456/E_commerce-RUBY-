...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<responders>.freeze, [">= 2".freeze, "< 4".freeze])
  s.add_runtime_dependency(%q<actionpack>.freeze, [">= 5.2".freeze, "< 7.1".freeze])
  s.add_runtime_dependency(%q<railties>.freeze, [">= 5.2".freeze, "< 7.1".freeze])
